...
import MikeIcon from '@/images/icons/MikeIcon';
...
const ChatBox = () => {
    return (
        <div className='w-full h-[80vh]'>
            ...
            <div className='border-l border-[#572E91] w-full h-full flex flex-col justify-end p-6'>
                <div className='message-box max-h-[70vh] overflow-auto hidden-scroller pb-4'>
                ...
                <div className='flex items-center gap-3 justify-between mt-4'>
                    <input
                        type="text"
                        className='px-4 py-2  w-full rounded-xl rounded-r-none border-r-0 bg-[#FFFFFF] text-lg placeholder:text-base placeholder:bg-transparent'
                        autoFocus={true}
